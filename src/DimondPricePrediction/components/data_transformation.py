...
from sklearn.preprocessing import StandardScaler #Handliong Feature Scaling
...
@dataclass #No need to define init functions if we use dataclass
...
class DataTransformation:
    ...
    def get_data_transformation(self):
        ...
        try:
            ...
            logging.info("exception occured during the Get DataTransformation stage")
    ...
    def initiate_data_transformation(self, train_path,test_path):     
        try:
            ...
            logging.info("exception occured during the Initialize DataTransformation stage")
            raise customexception(e,sys)
